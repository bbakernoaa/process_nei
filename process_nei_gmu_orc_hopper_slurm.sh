...
#SBATCH --time=0-12:00:00            # Run for max of 00 hrs, 10 mins, 00 secs
#SBATCH --nodes=1                    # Request N nodes
#SBATCH --ntasks-per-node=24         # Request n tasks per node
#SBATCH --mem=100G                   # Request nGB RAM per core

#Environment Setings
conda activate process_nei

./run_all_area_test_xargs_gmu-nei2019.sh
